...
parser.add_argument(
    "--x-legend", help="Label for the x-axis"
)
parser.add_argument(
    "--force-zero-y", 
    action="store_true", 
    help="Force Y-axis (Time) to start from 0. If omitted, scales to data range."
)
...
if args.x_legend:
    plt.xlabel(args.x_legend)

# --- Modification 2: Y-Axis Scaling ---
# Default behavior is auto-scaling to data (good for high offsets).
# This forces 0 only if requested.
if args.force_zero_y:
    plt.ylim(bottom=0)
